...
it out of*. It ends at a gate: nothing gets planned or built here.
...
3. Dispatch the `architect` subagent with a brief containing:
   ...
   - the list of MCP servers, skills and plugin commands available in this
     ...
     inside a subagent.
4. When it returns, read the written design yourself. Check it cites real
...
5. Report to the user: the recommended approach, which search layer the answer
