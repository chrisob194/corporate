...
Nine ship today: `typescript-playbook` for the typechecker,
...
store, and one per Bun doc area — `bun-runtime-playbook`, `bun-pm-playbook`,
...
| Skill | `plugins/corporate/skills/` | `corporate-pipeline`, `whiteboard`, `hr-report`, `typescript-playbook`, `typescript-mcp-playbook`, `oauth-playbook`, `mcp-oauth-playbook`, `sqlite-playbook`, `bun-runtime-playbook`, `bun-pm-playbook`, `bun-bundler-playbook`, `bun-test-playbook` |
