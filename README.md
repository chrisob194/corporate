...
Eighteen ship today: `typescript-playbook` for the typechecker,
...
`angular-playbook` for the frontend single-page-app surface,
`tailwind-playbook` for the utility-class styling surface, and
